...
START_TEST(eq_normal_test) {
  ...
  // B_filler_normal[_i]); printf("actual:%d expected:%d\n", actual, expected);
  // printf("\n_________\n");
...
static double A_filler_edge[] = {324.4123142, 0, 1};
static double B_filler_edge[] = {324.4123143, 0.000001, 1};
